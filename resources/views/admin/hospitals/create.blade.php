                        ...
                        <div class="card-block ">
                            ...
                            <div class="login-card0 auth-body0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-5">
                                        <input type="number" name="latitude" value="{{old('latitude')}}" step="any" autocomplete="off" class="form-control" placeholder="Enter latitude">
                                    ...
                                    <div class="col-4">
                                        <input type="number" name="longitude" value="{{old('longitude')}}" step="any" autocomplete="off" class="form-control" placeholder="Enter longitude">
