    ...
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="row justify-content-center">
                <div class="col-md-8 ">
                    <!-- Form -->
                        {!! Form::open(array('route' => ['admin.patients.update',$patient->id],'method'=>'PUT','class'=>'','files'=>true)) !!}
                        ...
                        <div class="card-block ">
                            ...
                            <div class="login-card0 auth-body0">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" name="name" value="{{old('name',$patient->name)}}" required autocomplete="off" class="form-control" placeholder="Patient Name">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" name="mobile" value="{{old('mobile',$patient->mobile)}}" autocomplete="off" class="form-control" placeholder="Patient Mobile">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input type="email" name="email" value="{{old('email'.$patient->email)}}" autocomplete="off" class="form-control" placeholder="Patient Email">
                                            @if ($errors->has('email'))
                                                <span class="help-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            {{Form::textArea('address',$value=old('address',$patient->address), ['class' => 'form-control','rows'=>'2','placeholder'=>'Patient Address','required'=>true])}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            {{Form::textArea('details',$value=old('details',$patient->details), ['class' => 'form-control','rows'=>'2','placeholder'=>'Patient Details','required'=>false])}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-2">
                                        <input type="number" name="age" value="{{old('age',$patient->age)}}" required autocomplete="off" class="form-control" placeholder="Age">
                                    ...
                                    <div class="col-3">
                                        <input type="text" value="{{old('patient_no',$patient->patient_no)}}" required readonly autocomplete="off" class="form-control">
                                    ...
                                    <div class="col-2">
                                        {{Form::select('status', [\App\Models\Patient::ACTIVE  => 'Active' , \App\Models\Patient::INACTIVE  => 'Inactive'],$patient->status, ['class' => 'form-control'])}}
                                        <span>Status</span>
                                    ...
                                    <?php $max=$maxSerial+1; ?>
                                    <div class="col-md-2">
                                        {{Form::number('sequence',$patient->sequence, ['min'=>'1','max'=>$max,'class' => 'form-control','required','readonly'=>false])}}
                                        <span>Sequence</span>
                                    </div>
                                </div>
