        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu " dropdown-icon="style3" subitem-icon="style6">
                ...
                <ul class="pcoded-submenu">
                    ...
                    {{--Sub Menu--}}
                    <li class=" ">
                        <a href="{{route('admin.doctors.create')}}" data-i18n="nav.page_layout.rtl">
                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
                            <span class="pcoded-mtext">Create Doctor</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="{{route('admin.doctors.index')}}" data-i18n="nav.page_layout.rtl">
                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
