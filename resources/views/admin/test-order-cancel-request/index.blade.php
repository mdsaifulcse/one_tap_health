        ...
        <div class="page-header">
            ...
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item">
                        {{--<a href="{{route('admin.test-order-cancel-request.create')}}" class="btn btn-info btn-sm" title="Create New Order"><i class="icofont icofont-plus"></i> Test Order</a>--}}
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>All Test Order Cancel List</h5>
                            <span> </span>
        ...
        $(function() {
            table= $('.datatable-ajax').DataTable( {
                ...
                columns: [
                    ...
                    { data: 'cancel_status',name:'test_order_cancel_requests.cancel_status'},
                    { data: 'refund_status',name:'test_order_cancel_requests.refund_status'},
                    { data: 'payment_status',name:'test_orders.payment_status'},
                    { data: 'created_at',name:'test_order_cancel_requests.created_at'},
                    { data: 'control'},
