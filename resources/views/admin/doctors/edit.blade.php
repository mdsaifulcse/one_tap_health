    ...
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="row justify-content-center">
                <div class="col-md-8 ">
                    <!-- Form -->
                    {!! Form::open(array('route' => ['admin.doctors.update',$data->id],'method'=>'PUT','class'=>'','files'=>true)) !!}
                        ...
                        <div class="card-block ">
                            ...
                            <div class="login-card0 auth-body0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="name" value="{{old('name',$data->name)}}" required autocomplete="off" class="form-control" placeholder="Doctor Name">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="mobile" value="{{old('mobile',$data->mobile)}}" autocomplete="off" class="form-control" placeholder="Doctor mobile">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="email" name="email" value="{{old('email',$data->email)}}" autocomplete="off" class="form-control" placeholder="Doctor email">
                                        @if ($errors->has('email'))
                                            <span class="help-block">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="bmdc_no" value="{{old('bmdc_no',$data->bmdc_no)}}"  autocomplete="off" class="form-control" placeholder="Doctor BMDC(Bangladesh Medical & Dental Council) Number">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="institute" value="{{old('institute',$data->institute)}}"  autocomplete="off" class="form-control" placeholder="Doctor Institute">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="designation" value="{{old('designation',$data->designation)}}"  autocomplete="off" class="form-control" placeholder="Doctor designation">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        {{Form::select('department', $department,$data->department, ['class' => 'form-control','placeholder'=>'Select one','required'=>true])}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <textarea rows="4" placeholder="Doctor bio " class="form-control"  name="bio" cols="50"><?php echo $data->bio;?></textarea>
                                        @if ($errors->has('bio'))
                                            <span class="help-block">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        {{Form::textArea('address',$value=old('address',$data->address), ['class' => 'form-control','rows'=>'2','placeholder'=>'Doctor Address','required'=>false])}}
                                ...
                                <div class="form-group row {{ $errors->has('photo') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-3">
                                        {{Form::select('status', [\App\Models\Doctor::ACTIVE  => 'Active' , \App\Models\Doctor::INACTIVE  => 'Inactive'],$data->status, ['class' => 'form-control'])}}
                                        <span>Status</span>
