    ...
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="row justify-content-center">
                <div class="col-md-8 ">
                    <!-- Form -->
                        {!! Form::open(array('route' => ['admin.tests.update',$data->id],'method'=>'PUT','class'=>'','files'=>true)) !!}
                        ...
                        <div class="card-block ">
                            ...
                            <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-7">
                                            {!! Form::select('category_id',$categories,$data->category_id, ['id'=>'loadSubCategory','placeholder' => '--Select Category --','class' => 'form-control select2tags','required'=>true]) !!}
                                        ...
                                        {{--<div class="col-5">--}}
                                            ...
                                            {{--<div class="" id="subCategoryList">--}}
                                                {{--{!! Form::select('subcategory_id',$subCategories,$data->subcategory_id, ['id'=>'loadThirdSubCategory','placeholder' => 'First Select Category','class' => 'form-control select2tags','required'=>true]) !!}--}}
                                        ...
                                        {{--<div class="col-3">--}}
                                            ...
                                            {{--<div class="" id="thirdSubCategoryList">--}}
                                                {{--{!! Form::select('third_category_id',$thirdSubCategories,$data->third_category_id, ['id'=>'loadFourthSubCategory','placeholder' => 'First Sub-Category','class' => 'form-control','required'=>false]) !!}--}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-7">
                                            <input type="text" name="title" value="{{old('title',$data->title)}}" required autocomplete="off" class="form-control" placeholder="Test Title">
                                            @if ($errors->has('title'))
                                                <span class="help-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-7">
                                            <input type="text" name="sub_title" value="{{old('sub_title',$data->sub_title)}}" required autocomplete="off" class="form-control" placeholder="Test sub title">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <textarea rows="4" placeholder="Test Description " class="form-control"  name="description" cols="5"><?php echo $data->description;?></textarea>
