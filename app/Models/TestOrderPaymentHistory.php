...
class TestOrderPaymentHistory extends Model
{
    ...
    protected $fillable=['user_id','test_order_id','payment_date','payment_amount','store_amount','payment_type','transaction_id','payment_track','payment_gateway','currency','payment_status'];
