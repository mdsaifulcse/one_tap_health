...
class BiggaponController extends Controller
{
    ...
    {
        $alldata=Biggapon::orderBy('sequence','DESC')->get();
        $max_serial=Biggapon::max('sequence')+1;
        ...
        $showOnPage=[\App\Models\Biggapon::HOME_PAGE  => \App\Models\Biggapon::HOME_PAGE ,
        ...
        $status=[\App\Models\Biggapon::ACTIVE  => \App\Models\Biggapon::ACTIVE ,
            \App\Models\Biggapon::INACTIVE  => \App\Models\Biggapon::INACTIVE];
        return view('admin.biggapon.index',compact('alldata','max_serial','place','showOnPage','status'));
    }
