...
class PublicSslCommerzPaymentControllerForTest extends Controller
{
    ...
    public function index(Request $request) 
    {
        ...
        //return 'dd';
            ...
            $post_data['tran_id'] = TestOrderPaymentHistory::generateTestOrderTrxID($id); // tran_id must be unique
           ...
           TestOrderPaymentHistory::create([
               ...
               'currency'=>'BDT',
               'payment_status'=>TestOrderPaymentHistory::INITIATE,
           ]);

            $sslc = new SSLCommerzTest();
